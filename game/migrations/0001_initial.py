...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('energy_altar', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('energy_fire', models.DecimalField(decimal_places=2, default=1, max_digits=5)),
                ('energy_waterfall', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ...
                ('last_food_gather', models.DateTimeField(blank=True, null=True)),
                ('last_wood_gather', models.DateTimeField(blank=True, null=True)),
